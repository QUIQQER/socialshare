...
/**
 * this file contains QUI\Socialshare\Shares\Surfingbird
 */
...
/**
 * Surfingbird class for social share
 *
 * @author  www.pcsg.de (Torsten Fink)
 * @package quiqqer/socialshare
 */
class Surfingbird extends Socialshare
{
    public function __construct(array $params = [])
    {
        $this->setAttribute('data-qui', 'package/quiqqer/socialshare/bin/controls/Surfingbird');
    ...
    public function getShareUrl(): string
    {
        ...
        return 'https://surfingbird.ru/share?url=' . $baseurl;
    }
    ...
    public function getCountUrl(): string
    {
        ...
        $url = "https://surfingbird.ru/button?url=";
