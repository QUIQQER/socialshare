...
/**
 * this file contains QUI\Socialshare\Shares\StumbleUpon
 */
...
/**
 * StumbleUpon class for social share
 *
...
class StumbleUpon extends Socialshare
{
    ...
    {
        return 'quiqqer-socialshare__link--stumbleupon';
    }
    ...
    {
        return QUI::getLocale()->get('quiqqer/socialshare', 'label-StumbleUpon');
    }
    ...
    {
        return QUI::getLocale()->get('quiqqer/socialshare', 'share-title-StumbleUpon');
    }
    ...
    public function getShareUrl(): string
    {
        ...
        return 'https://stumbleupon.com/submit?url=' . $baseurl;
    }
    ...
    public function getCountUrl(): string
    {
        ...
        $url = "https://stumbleupon.com/services/1.01/badge.getinfo?url=";
